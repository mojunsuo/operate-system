...
struct nfs_super nfs_super; 					/* 内存中的超级块 */
/******************************************************************************
* SECTION: FUSE操作定义
*******************************************************************************/
...
int main(int argc, char **argv)
{
	...
	nfs_options.device = strdup("/home/students/200110529/ddriver");
...
// 	newfs_options.device = strdup("/root/ddriver");//TODO: 这里填写你的ddriver设备路径
